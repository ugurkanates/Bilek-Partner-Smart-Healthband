...
public class GetDataFromBluetooth extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetooth_data_activitiy);
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == handlerState) {
                    ...
                    if (endOfLineIndex > 0) {
                        ...
                        txtString.setText("Veri alınıyor = " + dataInPrint);
                        ...
                        if (recDataString.charAt(0) == '#')
                        {
                            ...
                            sensorView0.setText(" Sensor 0 = " + sensor0);
