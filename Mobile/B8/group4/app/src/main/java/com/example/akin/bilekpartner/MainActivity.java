...
public class MainActivity  extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CircleProgressBar batarya = (CircleProgressBar) findViewById(R.id.carbs_progress2);
        final CircleProgressBar temp2 = (CircleProgressBar) findViewById(R.id.fats_progress4);
        ...
        handler.post(new Runnable(){
            ...
            public void run() {
                ...
                socketdata mdp =myDB.getLastData();


                pulse.setProgress((float) (mdp.pulse%360));
                pulse.setText(mdp.pulse + " bmp");


                temperature.setProgress((float) (mdp.tep%360));
                temperature.setText(String.valueOf(mdp.tep)+ " °C");


                batarya.setProgress((float) (mdp.bat));
                batarya.setText(String.valueOf(mdp.bat) + " batarya durumu volt " );

                temp2.setProgress((float) (mdp.tep2));
                temp2.setText(String.valueOf(mdp.tep2) + " cihazin sicakligi  " );
