...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (countSensor != null) {
            ...
            Toast.makeText(this, "Sensor mevcut değil!", Toast.LENGTH_LONG).show();
        }
...
//        sensorManager.unregisterListener(this);
    ...
    private void createDataSeries1() {
        ...
        seriesItem.addArcSeriesItemListener(new SeriesItem.SeriesItemListener() {
            @Override
            public void onSeriesItemAnimationProgress(float percentComplete, float currentPosition) {
                textToGo.setText(String.format("Hedef  %d Adım", (int) (seriesItem.getMaxValue() - currentPosition)));
        ...
        seriesItem.addArcSeriesItemListener(new SeriesItem.SeriesItemListener() {
            @Override
            public void onSeriesItemAnimationProgress(float percentComplete, float currentPosition) {
                textActivity1.setText(String.format("%.0f Adım", currentPosition));
            }
