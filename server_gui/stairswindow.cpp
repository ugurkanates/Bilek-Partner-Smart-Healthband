...
#include "ui_stairswindow.h"
#include "mainwindow.h"
stairswindow::stairswindow(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::stairswindow)
{
    ui->setupUi(this);
...
stairswindow::~stairswindow()
{
    delete ui;
}

void stairswindow::on_main_clicked()
{
    close();
...
void stairswindow::on_exit_clicked()
{
    close();
}
void stairswindow::setupPlot(QStringList wordList)
{
    mon=wordList.value(7).toInt();
    the=wordList.value(8).toInt();
    wed=wordList.value(9).toInt();
    thu=wordList.value(10).toInt();
    fri=wordList.value(11).toInt();
    sat=wordList.value(12).toInt();
    sun=wordList.value(13).toInt();
    QLinearGradient gradient(0, 0, 0, 400);
    gradient.setColorAt(0, QColor(90, 90, 90));
    gradient.setColorAt(0.38, QColor(105, 105, 105));
    gradient.setColorAt(1, QColor(250, 170, 20));
    ...
    fossil->setName("Günlük Merdiven Çıkma Grafiği(dk)");
    ...
    ui->plot->yAxis->setLabel("Günlük Merdiven Çıkma Grafiği");
...
QStringList stairswindow::csvReader()
{
       QFile file("../read.csv");
