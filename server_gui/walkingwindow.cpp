...
//exit the app
void walkingwindow::on_exit_clicked()
{
    close();
}
//back to main page
void walkingwindow::on_main_clicked()
{
    close();
...
void walkingwindow::setupPlot(QStringList wordList)
{
    mon=wordList.value(0).toInt();
    the=wordList.value(1).toInt();
    wed=wordList.value(2).toInt();
    thu=wordList.value(3).toInt();
    fri=wordList.value(4).toInt();
    sat=wordList.value(5).toInt();
    sun=wordList.value(6).toInt();
    QLinearGradient gradient(0, 0, 0, 400);
    gradient.setColorAt(0, QColor(90, 90, 90));
    gradient.setColorAt(0.38, QColor(105, 105, 105));
    gradient.setColorAt(1, QColor(0, 168, 140));
    ...
    fossil->setName("Günlük Yürüme Süresi(dk)");
    ...
    ui->plot->yAxis->setLabel("Günlük Yürüme Süresi");
...
QStringList walkingwindow::csvReader()
{
       QFile file("../read.csv");
